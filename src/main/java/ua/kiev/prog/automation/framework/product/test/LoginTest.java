...
public class LoginTest extends Test
{
    ...
    public void test()
    {
       ...
       System.out.println("TEST: " + this.name() + " | PHASE: TEST");
        ...
        //создаем объект мэйн пейджи. Фактически это как если бы мы обращались к конструктору: new MainPage();
        MainPage mainPage   = Component.getSingleton(Forum.class).mainPage();

        // Переходим на страницу логина
        LoginPage loginPage = mainPage.getLoginPage();
        // Заходим на форум
        MainPageLoggedIn dashboard = loginPage.login("potapenko.igorr@gmail.com", "0936534310");
        ...
        topic.topLinks().getHelp();
        //переход на страницу MainPageLoggedIn
